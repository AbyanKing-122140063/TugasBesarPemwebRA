...
function Home() {
  ...
  return (
    <div className="px-4 py-6">
      ...
      >
        <div>
          <img src="/images/pantai-tikus.jpg" alt="Pantai Tikus Emas" className="h-64 w-full object-cover" />
          <p className="legend">Pantai Tikus Emas</p>
        </div>
        <div>
          <img src="/images/padepokan.jpg" alt="Padepokan" className="h-64 w-full object-cover" />
          <p className="legend">Padepokan Putri Tri Agung</p>
        </div>
        <div>
          <img src="/images/cafe-tungtau.jpg" alt="Kedai Kopi" className="h-64 w-full object-cover" />
